...
{
  Menu, Tray, Tip, Clipboard Enhanced v2.3`n© 2008-2020 Volodymyr Frolov
...
clen_ShowHelpOnHotkeys()
{
  ...
  LV_Add("", "App Key + Insert", "Paste when Shift + Insert isn't working (in cmd.exe)")
  LV_Add("", "App Key + Delete", "Paste without format")
  LV_Add("", "App Key + Home", "Sort clipboard lines and paste")
  LV_Add("", "App Key + End", "Sort descending and paste")
  LV_Add("", "App Key + Page Up", "Paste in uppercase")
  LV_Add("", "App Key + Page Down", "Paste in lowercase")
