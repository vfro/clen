...
taskkill /IM clipboard_enhanced-v1.1.exe > nul 2>&1
...
Ahk2Exe.exe /in clen.ahk /icon ../Resources/clen.ico /out clipboard_enhanced-v1.1.exe /NoDecompile
start clipboard_enhanced-v1.1.exe
